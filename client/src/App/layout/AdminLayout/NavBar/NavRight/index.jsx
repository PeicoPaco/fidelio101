...
const NavRight = (props) => {
    ...
    const logoutCurrentUser = () => dispatch({type: actionTypes.LOG_OUT})
    const setCurrentUser = (currentUser) => dispatch({type: actionTypes.LOG_IN, currentUser: currentUser})

    const loggingOut = () => {
        signOut(auth).then(() => logoutCurrentUser())
    }
    ...
    useEffect(() => {
        ...
        const unsubscribe =onAuthStateChanged(auth, (currentUser) =>{
            if (currentUser != null) {
                currentUser.getIdToken().then(() => setCurrentUser(currentUser))
            }
            else {
                logoutCurrentUser()
            }
    ...
    if (!firebaseauth.currentUser) {
        console.log("User desde Nav Derecho: ", firebaseauth.currentUser);
        return <Redirect to='/'/>
    }
                    ...
                    <Dropdown drop={!props.rtlLayout ? 'left' : 'right'} className="dropdown" alignRight={!props.rtlLayout}>
                        ...
                        <Dropdown.Menu alignRight className="profile-notification">
                            <div className="pro-head bg-dark">
                                ...
                                <a href={'/'} className="dud-logout" title="Logout" onClick={() => loggingOut()}>
